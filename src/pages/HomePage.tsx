        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="text-lg text-gray-500 leading-relaxed max-w-2xl mx-auto">
              I write about anything that comes to my mind, My Ideas range from civil administration to Defence and everything in between.
            </p>
            ...
            {[
              {
                ...
                desc: "Building things people actually want, not just technically impressive toys.",
              },
              {
                icon: "🌏",
                title: "Geo-Politics",
                desc: "Reporting on major geopolitical events.",
              },
              {
                icon: "💲",
                title: "Economy",
                desc: "Macro economic trends combined with Micro economic factors.",
              },
              {
                icon: "🔥",
                title: "Hot Takes",
