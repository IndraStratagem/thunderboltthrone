...
export const hallOfFameTweets: HallOfFameTweet[] = [
  {
    id: "1",
    rank: 1,
    tweetUrl: "https://x.com/desishitposterr/status/2036868535813800026?s=20",
    category: "brutal-reply",
    commentary: "Viktor the Gujjew cooked both jihadis",
  },
  {
    id: "2",
    rank: 2,
    tweetUrl: "https://x.com/memenist_/status/2040277171990843547?s=20",
    category: "brutal-reply",
    commentary: "Cooking jihadis with mathematical operators",
  },
  {
    id: "3",
    rank: 3,
    tweetUrl: "https://x.com/yeagerist129/status/2028050422385254798?s=20",
    category: "brutal-reply",
    commentary: "Bhadwe Congressi owned in a single line",
  },
  {
    id: "4",
    rank: 4,
    tweetUrl: "https://x.com/Chhaliya__/status/2041734859107004457?s=20",
    category: "savage-post",
    commentary: "Bhikaristan PM's Draft Tweet Trolling",
  },
  {
    id: "5",
    rank: 5,
    tweetUrl: "https://x.com/prisha_here/status/2027292361437659608?s=20",
    category: "savage-post",
    commentary: "Guys, this is called layered banging",
  },
  {
    id: "6",
    rank: 6,
  ...
  },
  {
    id: "7",
    rank: 7,
    tweetUrl: "https://x.com/aakash__163/status/2027709805964759437?s=20",
    category: "brutal-reply",
    commentary: "This Goes on to show Indians can cook Pakistanis whatever the situation be",
  },
  {
    id: "8",
    rank: 8,
